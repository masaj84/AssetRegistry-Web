      ...
      >
        ...
        <div className="p-4 border-t border-border dark:border-border/50">
          ...
          <Link
            ...
            onClick={() => setSidebarOpen(false)}
            className={cn(
              'nav-profile w-full flex items-center gap-2 px-3 py-2 text-sm transition-colors mb-1',
          ...
          >
            ...
            <span className="font-mono">{t('app.settings')}</span>
          </Link>
          <button
                  ...
                  <>
                    ...
                    <li className="text-foreground font-medium">
                      {location.pathname.includes('/assets/new') ? t('app.newAsset') :
                       ...
                       location.pathname.includes('/settings') ? t('app.settings') : ''}
                    </li>
                  </>
                )}
              </ol>
