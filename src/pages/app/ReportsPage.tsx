    ...
    <div className="space-y-8">
      ...
      <div className="border border-border relative overflow-hidden">
        ...
        <div className="relative py-16 px-6 text-center">
          ...
          <h2 className="text-2xl font-light mb-3">Reports module in development</h2>
          ...
          <div className="flex items-center justify-center gap-2 mt-8">
            ...
            <div className="w-2 h-2 bg-foreground/60 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }} />
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs text-muted-foreground border border-border px-3 py-1.5">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {plannedFeatures.map((feature, index) => (
          <div
            key={feature.title}
            className="border border-border p-6 opacity-60 hover:opacity-80 transition-opacity group"
          >
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 border border-border flex items-center justify-center text-muted-foreground flex-shrink-0 group-hover:border-foreground/30 transition-colors">
