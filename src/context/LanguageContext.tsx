...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Footer
    'footer.tagline': 'The immutable registry for valuable products. Every item has a story — we make sure it\'s never lost.',
  ...
  pl: {
    ...
    // Footer
    'footer.tagline': 'Niezmienny rejestr wartościowych produktów. Każdy przedmiot ma swoją historię — my sprawiamy, że nigdy nie zostanie utracona.',
